...
import { client, Spinner } from '../integrate';
...
const CreatePin = ({ user }) => {
    ...
    return (
			<div className="flex flex-col justify-cnter items-center mt-5 lg:h-4/5">
				{fields && (
				...
				<div className="flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5  w-full">
								...
								<label>
									<div className="flex flex-col items-center justify-center h-full">
										...
										<p className="mt-32 text-gray-400">
											use high-quality JPG, AVG, PNG, GIF less than 20MB
										</p>
									</div>
									<input
										type="file"
					...
					<div className="flex flex-1 flex-col gap-6 ig:pl-5 mt-5 w-full">
						<input
							type="text"
							value={title}
						...
						<div className="flex flex-col">
							<div>
								<p className="mb-2 font-semibold text-lg sm:text-base">
									Choose Pin Category
								</p>
								<select
